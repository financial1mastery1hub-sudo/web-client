    ...
    <section className="relative py-20 bg-gradient-to-br from-[#FFA500]/10 via-black via-[#FFD700]/15 to-black">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="relative group rounded-2xl overflow-hidden border border-[#FFD700]/20 shadow-2xl">
            <div className="relative h-80 bg-gradient-to-br from-[#FFD700]/20 to-[#FFA500]/20">
              <img
              ...
              >
                <div className="w-20 h-20 bg-gradient-to-br from-[#FFD700] to-[#FFA500] rounded-full flex items-center justify-center group-hover:scale-110 transition-transform shadow-2xl shadow-[#FFD700]/50">
          ...
          <div className="relative group rounded-2xl overflow-hidden border border-[#FFD700]/20 shadow-2xl">
            <div className="relative h-80 bg-gradient-to-br from-[#FFA500]/20 to-[#FF8C00]/20">
              <img
              ...
              <button
                ...
                className="absolute inset-0 flex items-center justify-center group"
              >
                <div className="w-20 h-20 bg-gradient-to-br from-[#FFA500] to-[#FF8C00] rounded-full flex items-center justify-center group-hover:scale-110 transition-transform shadow-2xl shadow-[#FFA500]/50">
                  <Play className="w-10 h-10 text-white fill-white" />
                </div>
              </button>
            </div>
        ...
        {isPlaying && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95 backdrop-blur-sm">
            <div className="relative w-full max-w-4xl mx-auto px-6">
              ...
              <div className="relative w-full bg-black rounded-2xl overflow-hidden border border-[#FFD700]/20 shadow-2xl">
