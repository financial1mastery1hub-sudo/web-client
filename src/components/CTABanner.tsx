    ...
    <section id="contact" className="relative py-20 bg-gradient-to-r from-black via-[#FFD700]/20 to-black">
      ...
      <div className="relative max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button className="group px-10 py-4 bg-gradient-to-r from-[#FFD700] to-[#FFA500] text-black rounded-full font-bold text-lg hover:shadow-2xl hover:shadow-[#FFD700]/50 transition-all flex items-center justify-center gap-2">
            Contact Sales
            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
          </button>
          <button className="px-10 py-4 border-2 border-[#FFD700] text-[#FFD700] rounded-full font-bold text-lg hover:bg-[#FFD700] hover:text-black transition-all">
            Download Catalog
          </button>
        </div>
      </div>
